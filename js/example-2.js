...
//     const response = await fetch(`https://api.320.ink/api/b?id=${id}`);
//     const data = await response.json();
//     return data;
// }
//
// document.querySelectorAll(".bilibili_card_res").forEach(block => {
//     const id = block.getAttribute("data-id").replace(/.*video\/(.*)\/?.*/, '$1')
//     const time = block.getAttribute("data-time")
//     const hidden_desc = block.getAttribute("data-desc")
//
//     block.innerHTML += ``
// });
//
